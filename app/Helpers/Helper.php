...
if (! function_exists('clientCurlRequest')) {
...
if (! function_exists('convert_price')) {
    ...
    function convert_price($price, $curr = null): float|int
    {
        ...
        $default_currency = setting('default_currency'); //22572
...
if (! function_exists('payoutMethod')) {
    ...
    {
        return $method = OrganizationPayoutMethod::where('organization_id', $organization_id)->where('payout_method', $payout_method)->first();
    }
}
...
if (! function_exists('instructorPayoutMethod')) {
    ...
    {
        return $method = InstructorPayoutMethod::where('instructor_id', $instructor_id)->where('payout_method', $payout_method)->first();
    }
}
