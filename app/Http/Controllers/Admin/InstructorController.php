...
class InstructorController extends Controller
{
    ...
    {
        Gate::authorize('instructors.index');
        try {
    ...
    {
        Gate::authorize('instructors.create');
    ...
    {
        Gate::authorize('instructors.store');
        if (isDemoMode()) {
            $data = [
                'status' => 'danger',
    ...
    {
        Gate::authorize('instructors.show');
        try {
    ...
    {
        Gate::authorize('instructors.edit');
        try {
            $user = $this->user->find($id);
            $data = [
                'expertises' => $expertiseRepository->activeExpertises(),
    ...
    {
        Gate::authorize('instructors.update');
        if (isDemoMode()) {
            $data = [
                'status' => 'danger',
                'error'  => __('this_function_is_disabled_in_demo_server'),
