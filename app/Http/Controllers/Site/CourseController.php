...
class CourseController extends Controller
{
    ...
    public function course(Request $request, CategoryRepository $categoryRepository, LevelRepository $levelRepository, SubjectRepository $subjectRepository): \Illuminate\Contracts\View\View|\Illuminate\Contracts\View\Factory|\Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse|\Illuminate\Contracts\Foundation\Application
    {
        try {
            $input                      = $request->all();
    ...
    public function categoryCourses($slug,Request $request, CategoryRepository $categoryRepository, LevelRepository $levelRepository, SubjectRepository $subjectRepository): \Illuminate\Contracts\View\View|\Illuminate\Contracts\View\Factory|\Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse|\Illuminate\Contracts\Foundation\Application
    {
        try {
    ...
    public function courseDetails($slug, UserRepository $userRepository, ReviewRepository $reviewRepository): \Illuminate\Contracts\View\View|\Illuminate\Contracts\View\Factory|\Illuminate\Http\RedirectResponse|\Illuminate\Contracts\Foundation\Application
    {
        try {
            ...
            $has_enrolled           = $reviewRepository->searchUserReview([
                'user_id'           => auth()->id(),
                'type'              => Course::class,
                'id'                => $course->id,
            ]);
    ...
    public function lessonDetails(Request $request, $course, $slug, LessonRepository $lessonRepository)
    {
        try {
