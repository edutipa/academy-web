...
class ProfileController extends Controller
{
    ...
    public function purchaseCourses(Request $request): \Illuminate\Contracts\View\View|\Illuminate\Contracts\View\Factory|\Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse|\Illuminate\Contracts\Foundation\Application
    {
        try {
    ...
    public function notificationDelete(Request $request, NotificationRepository $notification): \Illuminate\Http\JsonResponse |\Illuminate\Http\RedirectResponse
    {
        $selected_ids = $request->selected_id;
    ...
    public function systemStatus(Request $request, SettingRepository $setting): \Illuminate\Http\JsonResponse|\Illuminate\Routing\Redirector|\Illuminate\Http\RedirectResponse|\Illuminate\Contracts\Foundation\Application
    {
        if (isDemoMode()) {
            $data = [
                'status' => 'danger',
    ...
    public function accountDelete(Request $request, UserRepository $user): \Illuminate\Http\JsonResponse
    {
        if (isDemoMode()) {
            $data = [
                'status' => 'danger',
    ...
    public function wallet(WalletRepository $wallet, Request $request)
    {
    ...
    public function walletRecharge(Request $request, WalletRepository $wallet): \Illuminate\Http\JsonResponse|\Illuminate\Http\RedirectResponse
    {
        if (!setting('wallet_system')) {
            abort(404);
        }
    ...
    public function resourceDownload($id): \Symfony\Component\HttpFoundation\BinaryFileResponse|\Illuminate\Http\RedirectResponse
    {
        try {
    ...
    public function oneSignalSubscribe(Request $request): \Illuminate\Http\JsonResponse
    {
        try {
            $user = auth()->user();
