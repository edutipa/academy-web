                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="oftions-content-right mb-20">
                                    <a href="{{ route('blog-categories.create') }}" class="button-default gap-2">
                                                ...
                                                <td>
                                                    <div class="setting-check">
                                                        <input type="checkbox" class="status-change"
                                                               {{ ($category->status == 1) ? 'checked' : '' }} data-id="{{ $category->id }}" value="blog-category-status/{{$category->id}}"
                                                ...
                                                <td class="action-card">
                                                    <ul class="d-flex gap-30 justify-content-end">
                                                        @if(hasPermission('blog-categories.edit'))
                                                            <li>
                                                                <a href="{{ route('blog-categories.edit',$category->id) }}"><i class="las la-edit"></i></a>
                                                            </li>
                                                        @endif
