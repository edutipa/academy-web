                            ...
                            <div class="row gx-20">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        {{-- <input type="password" class="form-control rounded-2" id="SMTPPassword" placeholder="********"  name="smtp_password" value="@if(isDemoMode())@else {{ old('smtp_password') ? old('smtp_password') : env('MAIL_PASSWORD') }} @endif"> --}}
