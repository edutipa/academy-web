...
@endphp
  ...
  <ul class="nav pb-12 mb-20">
    ...
    <li class="nav-item" role="presentation">
      <a href="{{ route('courses.organization', $organization_id) }}" class="nav-link  ps-0 {{ menuActivation(['admin/organizations/*/courses*'], 'active') }}" id="overview"  aria-controls="organisationOverview" aria-selected="true">{{__('courses')  }}</a>
    </li>

    <li class="nav-item" role="presentation">
      <a href="{{ route('organizations.staff.index',$organization_id) }}" class="nav-link  ps-0 {{ menuActivation(['admin/organizations/*/staff*'], 'active') }}" id="overview"  aria-controls="organisationOverview" aria-selected="true">{{__('Staff')  }}</a>
    </li>
