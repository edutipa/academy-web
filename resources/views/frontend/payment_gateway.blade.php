                                ...
                                <div class="col-lg-3 col-md-3 col-4">
                                    <div class="payment-methods-item">
                                        ...
                                        <label for="uddokta_pay">
                                            <img src="{{ static_asset('images/payment-icon/uddokta_pay.png') }}"
                                                 alt="KKiaPay">
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="checkout-billing m-t-50">
                            <div class="section-title-v3 color-dark m-b-15">
                                ...
                                <strong class="active_color">Available balance
                                    : {{ get_price(auth()->user()->balance) }}</strong>
                            </div>
                    ...
                    <div class="checkout-sidebar">
                                ...
                                @else
                                    ...
                                    <div
                                        ...
                                        <div class="book-text-content">
                                            ...
                                            <div class="quantity-price-wrapper">
                                                <span class="quantity">1 ×</span>
                                                <span class="price">{{ get_price($course->price) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                        ...
                        <div class="cart-product-calculation m-t-sm-15">
                            <table class="table">
                                ...
                                <tr>
                                    <td>{{ __('sub_total') }}</td>
                                    <td>{{ get_price($user_carts->sum('sub_total')) }}</td>
                                </tr>
                                <tr>
                                    <td>{{ __('discount') }}</td>
                                    <td>{{ get_price($user_carts->sum('discount')) }}</td>
                                </tr>
                                @if(setting('coupon_system'))
                                    <tr>
                                        <td>{{ __('coupon_discount') }}</td>
                                        <td>{{ get_price($total_discount) }}</td>
                                    </tr>
                                @endif
                                <tr>
                                    <td>{{ __('total') }}</td>
                                    <td>{{ get_price($amount) }}</td>
                                </tr>
                                </tbody>
                            </table>
                            <div>
