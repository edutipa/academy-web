...
Route::group(['prefix' => localeRoutePrefix()], function () {
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'verified', 'adminCheck', 'PermissionCheck']], function () {
        ...
        Route::get('language/{language}/translations', [LanguageController::class, 'translationPage'])->name('language.translations.page');
        Route::post('languages/{language}', [LanguageController::class, 'updateTrans'])->name('admin.language.key.update');
        ...
        Route::post('mobile-gdpr', [MobileAppSettingController::class, 'updateGdpr'])->name('update.mobile.gdpr');
    ...
    Route::post('apikeys/revoke', [ApiKeyController::class, 'revoke']);
